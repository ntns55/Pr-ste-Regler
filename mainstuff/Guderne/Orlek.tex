...
\end{table}
\todo{Blodrus ændredt til at det ikke kan være præsten, og at i egentlig går i blodrus.}
...
\textbf{Vigtigt:} Folk du helbreder er stadig påvirket af almindelige dødregler og kan derfor ikke kæmpe i 10 minutter.\todo{Mindsket mængde af Mana man får tilbage}

\section{Orleks Navn}
\textbf{Type:} Negativmagi\\ 
\textbf{Kategori:} Afhænger af Niveau\\
Tvinger en person i knæ.\\
\textbf{Kommando:} "Ærefrygt, Knæl, 30 sekunder"\todo{Tilføjet tid}
