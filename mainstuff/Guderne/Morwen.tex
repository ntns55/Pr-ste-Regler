...
\begin{table}[H]
    ...
    \makebox[\linewidth]{           
        \begin{tabular}{|p{0.075\textwidth}|p{0.25\textwidth}|p{0.25\textwidth}|p{0.25\textwidth}|p{0.25\textwidth}|}
            ...
            Niveau & Dødens nåde & Tidens Nål & Skatter og Død & Dødens beskyttelse \\\hline
        
            1 &  
            Helbred 1 bevidstløs person 1 LP.& 
            Så længe du messer tager reparer rustning halvt så lang tid (Rundet op).&
            ...
            Så længe du messer tager reparer rustning, førstehjælp og Helbred sår halvt så lang tid (Rundet op).& 
            ...
            Så længe du messer tager alle evner fra Alkymist, Barde, Handelsmand, Helbreder, Smed og Strateg halvt så lang tid (Rundet op).& 
...
\textbf{Effekt:} Alle der står inden for 5 meter af dig vil blive påvirket af denne effekt. Denne effekt varer så længe du bliver ved med at bede en bøn til Morwen, og stopper derefter. Dette inkludere at fortælle nye folk effekten af denne magi. Det foreslåes derfor at du forklarer effekten før du kaster denne magi. Der skal ikke bruges end bøn til at kaste denne magi.\\
