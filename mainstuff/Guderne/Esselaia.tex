...
\begin{table}[H]
    ...
    \makebox[\linewidth]{           
        \begin{tabular}{|p{0.075\textwidth}|p{0.25\textwidth}|p{0.25\textwidth}|p{0.25\textwidth}|p{0.25\textwidth}|}
            ...
            Niveau & Helbredelse & Elementernes beskyttelse & Monisme & Naturlig harmoni \\\hline
...
\todo{Foreslåede stier:Helbredelse der inkludere fjerning af negative effekter. Element sti der giver elemt defensive evner Non-violence sti. Barrirere sti.}

\section{Helbredelse}\todo{Ændret hvor mange denne rammer, og givet den extra effekter.}
