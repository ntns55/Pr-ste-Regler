\chapter*{Raffael Moordet}\addcontentsline{toc}{chapter}{Raffael Moordet}
...
\section*{Dæmon blod}\addcontentsline{toc}{section}{Dæmon blod}
...
\section*{Dæmonernes hjælp}\addcontentsline{toc}{section}{Dæmonernes hjælp}
...
\subsection*{Villigt sind}\addcontentsline{toc}{subsection}{Villigt sind}
\textbf{Passiv effekt}\\
...
\subsection*{Dæmonisk berøring}\addcontentsline{toc}{subsection}{Dæmonisk berøring}
\textbf{Type:} Negativ magi\\
\textbf{Kategori:} Berøringsmagi\\
En person som bliver berørt bliver tvunget til at knæle.\\
\textbf{Kommando:} “Ærefrygt - 15 sekunder”

\subsection*{Åbent Sind}\addcontentsline{toc}{subsection}{Åbent Sind}
Passiv effekt\\
Vælg 2 effekter fra magien \textbf{Villigt sind}.

\subsection*{Bundet sjæl}\addcontentsline{toc}{subsection}{Bundet sjæl}
...
\section*{Dæmonernes redskab}\addcontentsline{toc}{section}{Dæmonernes redskab}
...
\subsection*{Livs Drikker}\addcontentsline{toc}{subsection}{Livs Drikker} Denne effekt er en positiv magi, som kun påvirker dig. Denne markeres med et rødt bånd omkring dit våben. Denne effekt kan ikke kastes på Pistoler, pile, buer eller et hvilket som helst andet våben der bruger projektiler.\\ 
...
\section*{Korrupt beskyttelse}\addcontentsline{toc}{section}{Korrupt beskyttelse}
\textbf{Type:} - \\
